        ...
        <div className="project_overview_container" id="overview">
            <Row>
                <Col sm={12} md={7}>
                    ...
                    <div className="project_overview_content">Many first-time users of Tableau Prep did not come back for a second use. Usability Testings were conducted to identify problem areas and opportunity for improvement. The project was therefore initiated to tackle the problems discovered and bring about a delightful and engaging first-time experience to the new users. <u>Due to NDA, the piece will only give an overview of the project without exposing any details.</u></div>
                </Col>
        
                <Col sm={12} md={5}>
                    <div className="project_overview_title">Teammates</div>
                    <div className="project_overview_content">I worked with the product manager, user researchers, visual designers, techinical writers and developers on this projects and get inspiring feedback and huge supports from other UX designers and researchers from the Data Managerment Team and Onboarding Team.</div>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col sm={12} md={3}>
                    ...
                    <div className="p_small text-center">Explored in-product fixes and onboarding features thru rapid-prototyping</div>
                    ...
                    <Col md={12} lg={9}>
                        <div className="project_container">
                            ...
                            <section className="project_body" id="impact">
                                ...
                                <p>The onboarding features got good feedback in the usability testing. The success rates of tasks such as connecting data and combining data was improved. Users were able to start working with Prep, engage with more advanced features and understand the unique values of the product.</p>
                                <div className="project_quote">
                                    <div className="project_separator_inner_wrapper_small">
                                        <p className="project_quote_text">"It's actually not that hard! I will probably need to spend more time on it. Once I got a feel for it, it can see that it's a super intuitive and much faster way to clean my data."</p>
                                    </div>
                            ...
                            <section id="relate" className="project_body">
                                    ...
                                    <p>In the 12 weeks, I also helped to flesh out some design ideas, brought them to high fidelity and supported development team specify the design. These features were <a className="text-link" target="_blank" href="https://www.tableau.com/about/blog/2020/9/new-tableau-prep-group-steps-custom-fiscal-dates-and-more">shipped in the 2020.3.3 release.</a></p>
                                    <h6>Ghosted Clean Step</h6>
                                    <p>Users want to start cleaning after connecting their data. However, the interface at that moment misled their attempt to take action on the preview instead of adding a clean step to start prepping. Therefore, a ghosted clean step was designed to improve the discoverability of the cleaning interface. Also, this new feature as a short cut benefited power users as well.</p>
                                    <ImageZoom
                                        image={{
                                    ...
                                    <p>Users want to define the start of the fiscal year and show month or quarter number correspondingly. To allow more flexible date field configuration, custom fiscal year was introduced as the first step. Users can now convert date field to month or quarter, and select the start of the year.</p>
                                    <ImageZoom
                                        image={{
