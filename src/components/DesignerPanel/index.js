...
function DesignerPanel (props) {
    ...
    return (<div className="featureWorkerContainer">
                ...
                <WorkCard url='/work/tableauprep' imgUrl='/images/tableau/tableau.png' name='First 5 minutes in Tableau Prep' tagline='Improve the onboarding experience for new users.' description='For new users' labels={['work project', 'desktop','interaction design', 'onboarding', 'growth UX', 'design strategy','Data Prep Tool']} bgColor="#FFF7EF" tColor="#0f0f0f"/>
                <WorkCard url='/work/IoT' imgUrl='/images/IoT/mockup_multiscreens.png' name='Smart City Street Light Management Tool' tagline='A tool that helps lighting infrastructure administrators to control smart street lights energy-efficiently, accurately and easily on different occasions.' description='For city managers' labels={['Shipped','work project', 'product thinking 0-1', 'Web', 'interaction design','IoT','Management Tool']} bgColor="#FFF7EF" tColor="#0f0f0f"/>
                <WorkCard url='/work/sw' imgUrl='/images/sw_mockup_big.png' name='Seattle Works' tagline='A web redesign practice for clearer information hierarchy and better visual communication.' description='For non-profits' labels={['school project','Web', 'redesign','visual design', 'Visual Communication', 'IA']} bgColor="#FFF7EF" tColor="0f0f0f"/>
             
                <WorkCard url='/work/abstreet' imgUrl='/images/mockup_abstreet.png' name='A/B Street' tagline='A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.' description='For citizens' labels={['passion project','desktop game', 'game ui', 'interaction design']}  bgColor="#FFF7EF" tColor="#0f0f0f"/>

                {/* <WorkCard url='/work/photome' imgUrl='/images/mockup_photome.png' name='PhotoMe' tagline='A mobile app that helps others to capture a better you.' description='For portrait-lovers' labels={['individual project','mobile', 'interaction design', 'visual design', 'fosters communication']}  bgColor="#FFF7EF" tColor="#0f0f0f"/> */}
