...
function DesignerPanel (props) {
    ...
    return (<div className="featureWorkerContainer">
                ...
                <WorkCard url='/work/abstreet' imgUrl='/images/mockup_abstreet.png' name='A/B Street' tagline='A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.' description='For gamer' labels={['passion project','desktop game', 'game ui design', 'interaction design']}  bgColor="#FFF7EF" tColor="#0f0f0f"/>
