...
function DesignerPanel (props) {
    ...
    return (<>
                ...
                <WorkCard url='/work/IoT' imgUrl='/images/IoT/mockup_multiscreens.png' name='An IoT-based smart city infrastructure management tool' tagline='A case study on how I designed a tool that helps lighting infrastructure administrators to control smart street lights energy-efficiently, accurately and easily on different occasions.' description='User Research + UX Design' labels={['Shipped','work project', 'product thinking 0-1', 'Web Design', 'interaction design','IoT','Management Tool']} bgColor="#f8f8f8" tColor="#0f0f0f"/>
                <WorkCard url='/work/sw' imgUrl='/images/sw_mockup_big.png' name='Seattle Works' tagline='A web redesign practice for clearer information hierarchy and better visual communication.' description='UX/UI Design' labels={['school side project','Web Redesign', 'visual design', 'Visual Communication', 'IA', 'organization website']} bgColor="#f8f8f8" tColor="0f0f0f"/>
             
                
                <WorkCard url='/work/photome' imgUrl='/images/mockup_photome.png' name='PhotoMe' tagline='A mobile app that empowers others to capture better you.' description='User Research + UX/UI Design' labels={['individual project','mobile app Design', 'interaction design', 'visual design', 'fosters communication']}  bgColor="#f8f8f8" tColor="#0f0f0f"/>
                <WorkCard url='/work/specs' imgUrl='/images/mockup_specs_big.png' name='Specs' tagline='A Figma plugin that helps UX/UI designers specify their designs and translate them into engineering language.' description='UX/UI Design + Development' labels={['Shipped','individual project', 'design sprint', 'prototyping with code','interaction design','design tool']} bgColor="#f8f8f8" tColor="0f0f0f"/>
